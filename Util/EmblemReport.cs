...
namespace Levante.Util
{
    ...
    public class EmblemReport
    {
        ...
        public EmblemReport(long collectibleHash)
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd($"Mozilla/5.0 (compatible; {AppConfig.App.Name}/1.0)");
            client.DefaultRequestHeaders.Add("X-API-KEY", AppConfig.Credentials.EmblemReportApiKey);
